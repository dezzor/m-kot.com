...
class JalangViewItems extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		$options = array();
		$options[0]= (object)array('value'=>0, 'text'=>JText::_('SELECT_ITEM_TYPE')) ;
		$types = array();
		...
		$jacontentlang = JHtml::_('contentlanguage.existing', true, true);
		array_unshift($jacontentlang, array('value'=>0, 'text'=>JText::_('JOPTION_SELECT_LANGUAGE')));
