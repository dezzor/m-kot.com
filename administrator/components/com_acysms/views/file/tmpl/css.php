...
<form action="index.php?option=<?php echo ACYSMS_COMPONENT ?>&amp;ctrl=file" method="post" name="adminForm"  id="adminForm" autocomplete="off">
	<fieldset>
		...
		<div class="toolbar" id="toolbar" style="float: right;">
			<table><tr>
			<td><a onclick="javascript:submitbutton('savecss'); return false;" href="#" ><span class="icon-32-save" title="<?php echo JText::_('SMS_SAVE',true); ?>"></span><?php echo JText::_('SMS_SAVE'); ?></a></td>
			</tr></table>
		</div>
	</fieldset>
