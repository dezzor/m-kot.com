...
<form action="index.php?option=<?php echo ACYSMS_COMPONENT ?>&amp;ctrl=customer" method="post" name="adminForm"  id="adminForm" enctype="multipart/form-data">
	<table class="adminform" width="100%">
		...
		<tr>
			...
			<td>
			<?php
				if(empty($this->customer->customer_credits_url)) $URL = $this->config->get('default_credits_url');
		...
		<tr>
			...
			<td>
				<?php echo $this->senderprofile->display('data[customer][customer_senderprofile_id]',@$this->customer->customer_senderprofile_id); ?>
			</td>
		</tr>
	</table>
	<div class="clr"></div>
