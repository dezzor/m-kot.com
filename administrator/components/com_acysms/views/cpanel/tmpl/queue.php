...
<legend><?php echo JText::_( 'SMS_QUEUE_PROCESS' ); ?></legend>
...
<fieldset class="adminform">
	<legend><?php echo JText::_( 'SMS_CRON' ); ?></legend>
	<table class="admintable" cellspacing="1">
		<tr>
			<td colspan="2">
			<?php
	...
	<fieldset class="adminform">
		<legend><?php echo JText::_( 'SMS_REPORT' ); ?></legend>
	...
	<fieldset class="adminform">
		<legend><?php echo JText::_( 'SMS_LAST_CRON' ); ?></legend>
		<table class="admintable" cellspacing="1">
			<tr>
				<td class="key" >
