		...
		<thead>
			<tr>
				...
				<th class="title titleorder">
					<?php echo JText::_('SMS_ORDERING'); echo JHTML::_('grid.order',  $this->rows );?>
				</th>
				<th class="title titletoggle">
		...
		<tbody>
			<?php
				...
				for($i = 0,$a = count($this->rows);$i<$a;$i++){
					...
					$publishedid = 'fields_published_'.$row->fields_fieldid;
					$requiredid = 'fields_required_'.$row->fields_fieldid;
					$backendid = 'fields_backend_'.$row->fields_fieldid;
					$frontcompid = 'fields_frontcomp_'.$row->fields_fieldid;
					$listingid = 'fields_listing_'.$row->fields_fieldid;
			?>
