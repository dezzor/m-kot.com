...
<form action="index.php?option=<?php echo ACYSMS_COMPONENT ?>&amp;ctrl=fields" method="post" name="adminForm"  id="adminForm" autocomplete="off">
	<table cellspacing="1" width="100%">
			...
			<table class="paramlist admintable">
				...
				<tr class="multivalues"  style="display:none">
					...
					<td>
						...
						<tr><td><?php echo JText::_('SMS_FIELD_VALUE')?></td><td><?php echo JText::_('SMS_FIELD_TITLE'); ?></td><td><?php echo JText::_('SMS_DISABLED'); ?></td><td></td></tr>
						<?php $optionid = 0;
						...
						<a class="btn" onclick="addLine();return false;" href='#' title="<?php echo $this->escape(JText::_('SMS_FIELD_ADDVALUE')); ?>"><?php echo JText::_('SMS_FIELD_ADDVALUE'); ?></a>
					</td>
				</tr>
			</table>
		</td>
		<td valign="top">
			...
			<table class="admintable"><tr><td class="key"><?php $this->fieldsClass->suffix='preview'; echo $this->fieldsClass->getFieldName($this->field); ?></td><td><?php echo $this->fieldsClass->display($this->field,$this->field->fields_default,'data[user]['.$this->field->fields_namekey.']'); ?></td></tr></table>
			</fieldset>
			<fieldset class="adminform">
			<legend>HTML</legend>
