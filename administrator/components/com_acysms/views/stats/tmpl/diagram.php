...
?><div id="acysms_content" >
	...
	<script language="JavaScript" type="text/javascript">
		...
		function drawChartSendProcess() {
			...
			var options = {
				...
				title: '<?php echo JText::_('SMS_SEND_PROCESS',true);?>',
				is3D:true,
		...
		function drawChartMsgSentByDate(){
			...
			var options = {
				...
				legend:'none',
				is3D:true,
				title: '<?php echo JText::_('SMS_MESSAGES_SENT',true)?>',
				legendTextStyle: {color:'#333333'}
			};
			vis.draw(dataTable, options);
		}
	...
	<form action="index.php?option=<?php echo ACYSMS_COMPONENT ?>" method="post" name="adminForm" autocomplete="off" id="adminForm" >
		<fieldset class="acysmsheaderarea">
			<div class="acysmsheader icon-48-stat" style="float: left;"><?php echo $this->escape($this->messageStat->message->message_subject); ?></div>
			<div class="toolbar" id="toolbar" style="float: right;">
				<table><tr>
				<td><a onclick="window.print(); return false;" href="#" ><span class="icon-32-acysmsprint" title="<?php echo JText::_('SMS_PRINT',true); ?>"></span><?php echo JText::_('SMS_PRINT'); ?></a></td>
				</tr></table>
			</div>
		</fieldset>
	</form>
