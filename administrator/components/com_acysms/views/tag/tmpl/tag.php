...
<div id="acysms_content">
	<div id="acysms_edit" class="acytagpopup">
		<div id="inserttagdiv">
			<input type="text" class="inputbox" style="width:300px;" id="tagstring" name="tagstring" value="" onclick="this.select();"> <button class="btn btn-primary" id="insertButton" onclick="insertTag();"><?php echo JText::_('SMS_INSERT_TAG')?></button>
		</div>
		<form action="<?php echo JRoute::_('index.php?option=com_acysms&tmpl=component'); ?>" method="post" name="adminForm"  id="adminForm"  autocomplete="off">
			<div id="plugarea">
