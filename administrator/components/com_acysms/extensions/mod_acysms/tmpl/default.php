...
?><div class="acysms_module<?php echo $params->get('moduleclass_sfx')?>" id="acysms_module_<?php echo $module->id; ?>">
	...
	<form action="<?php echo JURI::current(); ?>"  method="post" name="sendsms">
		...
		<div class="sendMessageDiv">
			<input class="btn btn-primary" type="submit" value="<?php echo empty($sendtext) ? JText::_('SMS_SEND') : ($sendtext);?>"/>
		</div>
