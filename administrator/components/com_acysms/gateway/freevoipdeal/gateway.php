...
class ACYSMSGateway_freevoipdeal_gateway extends ACYSMSGateway_default_gateway{
	...
	public $domain = "ssl://www.freevoipdeal.com";
	public $port = 443;


	public $name = 'FreeVoipDeal';
	...
	public function openSend($message,$phone){
		...
		$fsockParameter = "GET /myaccount/sendsms.php?".$stringToPost." HTTP/1.1\r\n";
		$fsockParameter.= "Host: www.freevoipdeal.com\r\n";
	...
	protected function interpretSendResult($result){
		...
		if(strpos($res, 'succes')) return true;
		else{
			if(preg_match('#<resultstring>(.*)</resultstring>#Ui', $res, $explodedResults2)){
				$this->errors[] = 'Error : '.$explodedResults2[1];
			}
			if(preg_match('#<description>(.*)</description>#Ui', $res, $explodedResults2)){
