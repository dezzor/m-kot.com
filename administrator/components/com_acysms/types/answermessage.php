...
class ACYSMSanswermessageType{
	...
	function ACYSMSanswermessageType(){
	...
	function display($value){
		...
		$text = ' <a '.$style.' class="modal" id="answer_edit" title="'.JText::_('SMS_EDIT_MESSAGE',true).'"  href="'.$linkEdit.'" rel="{handler: \'iframe\', size:{x:800, y:500}}"><img class="icon16" src="'.ACYSMS_IMAGES.'icons/icon-16-edit.png" alt="'.JText::_('SMS_EDIT_MESSAGE',true).'"/></a>';
		$text .= ' <a class="modal" id="answer_add" title="'.JText::_('SMS_CREATE_MESSAGE',true).'"  href="'.$linkAdd.'" rel="{handler: \'iframe\', size:{x:800, y:500}}"><img class="icon16" src="'.ACYSMS_IMAGES.'icons/icon-16-add.png" alt="'.JText::_('SMS_CREATE_MESSAGE',true).'"/></a>';
