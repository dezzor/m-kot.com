...
?>
<a class="reply-btn" href="#" onclick="jcomments.showReply(<?php echo $comment->id; ?>,1); return false;"></a>
<?php
						}
					}
					if ($this->getVar('button-quote') == 1) {
?>
<a class="quote-btn" href="#" onclick="jcomments.quoteComment(<?php echo $comment->id; ?>); return false;"></a>
<?php
					}
