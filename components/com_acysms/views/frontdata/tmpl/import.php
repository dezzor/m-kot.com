...
?><fieldset id="acysms_import_menu">
	<div class="toolbar" id="acysmstoolbar" style="float: right;">
		<table>
			<tr>
				<td id="acysmsbuttonimport"><a onclick="javascript:<?php if(ACYSMS_J16) echo "Joomla."; ?>submitbutton('importConfig'); return false;" href="#" ><span class="icon-32-import" title="<?php echo JText::_('SMS_IMPORT'); ?>"></span><?php echo JText::_('SMS_IMPORT'); ?></a></td>
