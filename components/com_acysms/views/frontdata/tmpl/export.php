...
?><fieldset id="acysms_export_menu">
	<div class="toolbar" id="acysmstoolbar" style="float: right;">
		<table>
			<tr>
				<td id="acysmsbuttonexport"><a onclick="javascript:<?php if(ACYSMS_J16) echo "Joomla."; ?>submitbutton('doexport'); return false;" href="#" ><span class="icon-32-import" title="<?php echo JText::_('SMS_EXPORT'); ?>"></span><?php echo JText::_('SMS_EXPORT'); ?></a></td>
