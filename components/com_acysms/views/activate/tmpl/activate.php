...
?><div id="acysmsactivation">
	...
	<form action="<?php echo JRoute::_( 'index.php' );?>" method="post" name="adminForm" id="adminForm" >
		<div id="ValidationPhoneNumber">
					...
					<?php
						$phoneToDisplay = '';
						if(!empty($this->user->user_phone_number)) $phoneToDisplay = $this->user->user_phone_number;
		...
		<div id="activatebutton_div" class="activatediv">
			<input class="button btn btn-primary" type="submit" value="<?php echo empty($this->activatetext) ? JText::_('SMS_ACTIVATE') : ($this->activatetext);?>"/>
		</div>
	</form>
