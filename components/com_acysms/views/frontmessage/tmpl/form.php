...
?><fieldset id="acysms_message_form_menu">
	<div class="toolbar" id="acysmstoolbar" style="float: right;">
		<table><tr>
			<td id="acysmsbuttonpreview"><a onclick="javascript:<?php if(ACYSMS_J16) echo "Joomla."; ?>submitbutton('preview'); return false;" href="#" ><span class="icon-32-smspreview" title="<?php echo JText::_('SMS_PREVIEW').' / '.JText::_('SMS_SEND'); ?>"></span><?php echo JText::_('SMS_PREVIEW').' / '.JText::_('SMS_SEND'); ?></a></td>
	...
	<div class="acyheader" style="float: left;"><h1><?php echo JText::_('SMS_MESSAGE').' : '.@$this->message->message_subject; ?></h1></div>
</fieldset>
<?php
