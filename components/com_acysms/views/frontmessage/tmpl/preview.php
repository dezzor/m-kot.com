...
?><fieldset id="acysms_preview_menu">
	<div class="toolbar" id="acysmstoolbar" style="float: right;">
		<table><tr>
			<td id="acysmsbutton_edit"><a onclick="javascript:<?php if(ACYSMS_J16) echo "Joomla."; ?>submitbutton('edit'); return false;" href="#" ><span class="icon-32-smsedit" title="<?php echo JText::_('SMS_EDIT'); ?>"></span><?php echo JText::_('SMS_EDIT'); ?></a></td>
