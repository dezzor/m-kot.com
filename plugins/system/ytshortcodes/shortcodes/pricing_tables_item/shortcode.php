	...
	switch ($type) {
		case 'style1':
			...
			$return = '<div class="col-xs-12 col-sm-6 col-md-'.round(12/$pcolumns).' col-lg-'.round(12/$pcolumns).'">
				...
				<div class="pricing-basic " style=""><h2>' . $yt_title . '</h2></div>' .
		...
		case 'style2':
			...
			$return = '<div class="col-xs-12 col-sm-6 col-md-'.round(12/$pcolumns).' col-lg-'.round(12/$pcolumns).'">
				...
				<div class="pricing-basic " style="background:'.$background.'; color:'.$color.'"><h2>' . $yt_title . '</h2><span class="pricing-featured">'.$yt_text.'</span></div>' .
				parse_shortcode(str_replace(array("<br/>", "<br>", "<br />"), " ", $content)) .
		...
		case 'style3':
			...
			$return = '<div class="col-xs-12 col-sm-6 col-md-'.round(12/$pcolumns).' col-lg-'.round(12/$pcolumns).'">
				<div class="'.$type.' column '.(('true' == strtolower($featured)) ? ' featured' : '') .'">
				<div class="pricing-basic " style="background:#e74847; color:'.$color.'"><h2>' . $yt_title . '</h2><span class="pricing-featured">'.$text.'</span></div>' .
