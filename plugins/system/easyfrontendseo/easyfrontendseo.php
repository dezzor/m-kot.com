...
class PlgSystemEasyFrontendSeo extends JPlugin
{
	...
	public function onBeforeCompileHead()
	{
		...
		if(!empty($metadata))
		{
			...
			$metadata_new = array('title' => $title, 'description' => $description, 'metaTags' => array('name' => array('robots' => $robots, 'keywords' => $keywords)));
			...
			{
				$metadata_new['metaTags']['standard'] = array('robots' => $robots, 'keywords' => $keywords);
			}
			...
			if(isset($head['metaTags']['name']['rights']))
			{
				$metadata_new['metaTags']['name']['rights'] = $head['metaTags']['name']['rights'];
			}
			elseif(isset($head['metaTags']['standard']['rights']))
			{
				$metadata_new['metaTags']['name']['rights'] = $head['metaTags']['standard']['rights'];
			}
